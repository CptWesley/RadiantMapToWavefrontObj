...
namespace RadiantMapToObj.Quake.Hammer
{
    ...
    /// <param name="OffsetNormals">The direction of each vertex.</param>
    public record DisplacementInfo(int Power, Vector StartingPosition, double Elevation, Grid<Vector> Normals, Grid<double> Distances, Grid<Vector> Offsets, Grid<Vector> OffsetNormals);
}
